...
const Portfolio = () => {
  ...
  const projects = [
    { id: 1, title: "CouponSwap", description: "CouponSwap for trading Amazon, Flipkart, and other coupons. Buy and sell easily to save money or earn cash.", image: "../src/assets/Couponhome.png", tags: ["React", "Tailwind CSS", "Node.js", "Express", "Html&css", "Javascript", "Postman", "MongoDB"], category: "all", github: "https://github.com/NAGESHJAGTAP/coupon_swap", live: "https://coupon-swap-discount-nu.vercel.app/" },
    { id: 2, title: "BrewBank", description: "A React (Vite) app integrating multiple APIs (banking, cocktails, meals, Harry Potter) with a dynamic, responsive UI.", image: "../src/assets/meals.png", tags: ["React", "Tailwind CSS", "API Integration", "Html", "CSS", "Javascript"], category: "all", github: "https://github.com/NAGESHJAGTAP/ract-website-Four-in-One", live: "https://ract-website-four-in-one-3wm8.vercel.app/" },
    { id: 3, title: "PlacePro", description: "A traveler-friendly web app for discovering hospitals, pharmacies, hotels, and more with real-time search and maps.", image: "../src/assets/placepro.png", tags: ["React", "Tailwind CSS", "Node.js", "Express", "Html&css", "Javascript", "Postman", "MongoDB"], category: "all", github: "https://github.com/NAGESHJAGTAP/place_pro", live: "https://your-portfolio-generator-demo.com" }, // Fixed broken URL
    { id: 4, title: "Personal Portfolio", description: "A responsive React & Tailwind CSS portfolio showcasing skills, projects, and contact details.", image: "../src/assets/portfollio (2).png", tags: ["React", "Tailwind CSS", "Javascript", "Html", "css"], category: "all", github: "https://github.com/NAGESHJAGTAP/full_stack_web_development_personal_Portfollio", live: "https://kiawebsite.netlify.app/" },
    { id: 5, title: "Kia Website", description: "A static HTML/CSS website showcasing Kia cars with features, images, and videos.", image: "../src/assets/kia.png", tags: ["Html", "css"], category: "all", github: "https://github.com/NAGESHJAGTAP/kia-Car-Website-Html-css-project", live: "https://kiawebsite.netlify.app/" },
    // Clone Projects
    { id: 1, title: "YouTube Clone", description: "A YouTube Clone with React.js, featuring video search via YouTube API.", image: "../src/assets/youtube.jpg", tags: ["React", "CSS", "JavaScript"], category: "clone", github: "https://github.com/NAGESHJAGTAP/react_youtube" },
    { id: 2, title: "Netflix Clone", description: "A Netflix clone webpage with sections like Top 10 and Trending Now.", image: "../src/assets/netflix.png", tags: ["Html", "CSS"], category: "clone", github: "https://github.com/NAGESHJAGTAP/Html-Css-clone-project/tree/main/Netflix-Clone" },
    { id: 3, title: "Amazon Clone", description: "A simple Amazon Clone with a responsive layout using HTML and CSS.", image: "../src/assets/Amazon.png", tags: ["Html", "CSS"], category: "clone", github: "https://github.com/NAGESHJAGTAP/Amazon_clone" },
    { id: 4, title: "Chessboard", description: "A digital chessboard with an 8x8 grid for casual or multiplayer play.", image: "../src/assets/ChessBord.png", tags: ["Html", "CSS"], category: "clone", github: "https://github.com/NAGESHJAGTAP/Html-Css-clone-project/tree/main/chessbord" },
    { id: 5, title: "Kidz World Clone", description: "A kid-friendly website replica with games and educational content.", image: "../src/assets/Kids.png", tags: ["Html", "CSS"], category: "clone", github: "https://github.com/NAGESHJAGTAP/Html-Css-clone-project/tree/main/kidz-world" },
    { id: 6, title: "Calculator", description: "A responsive calculator supporting basic arithmetic operations.", image: "../src/assets/Calculater.png", tags: ["Html", "CSS"], category: "clone", github: "https://github.com/NAGESHJAGTAP/Html-Css-clone-project/tree/main/calculaturs" },
    { id: 7, title: "Sudoku", description: "An interactive Sudoku game with an easy-to-use interface.", image: "../src/assets/sudoku.png", tags: ["Html", "CSS"], category: "clone", github: "https://github.com/NAGESHJAGTAP/Html-Css-clone-project/tree/main/Sudoku" },
    { id: 8, title: "Ludo", description: "A digital Ludo game with dice roll mechanics and multiplayer support.", image: "../src/assets/ludo.png", tags: ["Html", "CSS"], category: "clone", github: "https://github.com/NAGESHJAGTAP/Html-Css-clone-project/tree/main/ludo" },
    { id: 9, title: "Superwars", description: "A superhero vs. villain battle game with turn-based combat.", image: "../src/assets/superw.png", tags: ["Html", "CSS"], category: "clone", github: "https://github.com/NAGESHJAGTAP/Html-Css-clone-project/tree/main/superwars" },
    // Figma Projects
    { id: 1, title: "Coding Gita Website", description: "A Figma design for a coding bootcamp with an intuitive layout.", image: "../src/assets/Codinggita.png", tags: ["Figma", "UX Design", "Prototyping"], category: "figma", figma: "https://www.figma.com/design/IX2rMaAgSz81LEsBZdtWPT/Untitled?node-id=0-1&t=NXMtOWKAb6FU7Lk0-1" },
    { id: 2, title: "CouponSwap Website", description: "A user-friendly Figma design for trading coupons.", image: "../src/assets/Coupon.png", tags: ["Figma", "UI Design"], category: "figma", figma: "https://www.figma.com/design/r8LuUXUXeKoQy7hR5KIR3W/CoupenSwap?node-id=7-485&t=uQXo4JlCN5aQBSF5-1" },
    { id: 3, title: "Imagine with Serendipity", description: "A creative Figma concept with elegant UI elements.", image: "../src/assets/imagin.png", tags: ["Figma", "UX Design"], category: "figma", figma: "https://www.figma.com/design/erbmWnDPWqwe01v2RjdST8/Untitled?node-id=0-197&t=51tdF4C1cp9w2tEW-1" },
    { id: 4, title: "Breath Natural", description: "A nature-inspired Figma design promoting wellness.", image: "../src/assets/Nature.png", tags: ["Figma", "UX Design"], category: "figma", figma: "https://www.figma.com/design/0ZEWPi1xavgJmRadnEQsWL/Untitled?node-id=1-2&t=kPB1tHFbXR56JWcO-1" },
    { id: 5, title: "Instagram Mobile Design", description: "A Figma design replicating Instagram’s mobile UI.", image: "../src/assets/instagram.png", tags: ["Figma", "UX Design", "Prototyping"], category: "figma", figma: "https://www.figma.com/design/PAjCEAXYI7mm6OHvQVvi4Y/Untitled?node-id=4-39&t=aRCUYXPTIQmNTLgy-1" },
    { id: 6, title: "DualSense Controller", description: "A Figma design of the DualSense wireless controller.", image: "../src/assets/remote.png", tags: ["Figma", "UX Design"], category: "figma", figma: "https://www.figma.com/design/IX2rMaAgSz81LEsBZdtWPT/Untitled?node-id=21-2&t=zYFvbj9xzJirlZG3-1" },
  ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="relative w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 mx-auto">
                  <div className="w-full h-full bg-gray-800 rounded-lg overflow-hidden">
                    <img src="../src/assets/profilephoto.png" alt="Profile" className="w-full h-full object-cover" />
                  </div>
                  <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 w-56 h-56 sm:w-72 sm:h-72 md:w-96 md:h-96 border-8 border-blue-400 rounded-lg z-0 hidden sm:block"></div>
                  <div className="absolute -top-4 -left-4 sm:-top-6 sm:-left-6 w-56 h-56 sm:w-72 sm:h-72 md:w-96 md:h-96 border-8 border-blue-400 rounded-lg z-0 hidden sm:block"></div>
                </div>
              ...
              <div className="order-1 lg:order-2 text-center lg:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  ...
                  <a href="/assets/Nagesh_Jagtap_Resume.pdf" download className="px-4 py-2 sm:px-6 sm:py-3 border border-blue-600 text-blue-400 hover:bg-blue-700 hover:text-white font-medium rounded-md transition-all duration-300">Download Resume</a>
                </div>
              </div>
            </div>
          </div>
