...
//   // Certificates data (replace with your actual certificates)
//   const certificates = [
//     {
//       title: "Full-Stack Web Development",
//       issuer: "Coding Gita Bootcamp",
//       year: "2024",
//       description: "Completed an intensive program covering React.js, Node.js, MongoDB, and RESTful APIs, with hands-on projects in full-stack development.",
//       link: "https://example.com/certificate/full-stack" // Replace with actual link
//     },
//     {
//       title: "React.js Developer Certification",
//       issuer: "Coursera",
//       year: "2024",
//       description: "Earned certification in building dynamic, responsive web applications using React.js and modern JavaScript.",
//       link: "https://example.com/certificate/react-js" // Replace with actual link
//     },
//     {
//       title: "UI/UX Design with Figma",
//       issuer: "Udemy",
//       year: "2023",
//       description: "Mastered UI/UX design principles and prototyping using Figma, focusing on user-centric design and wireframing.",
...
//       issuer: "FreeCodeCamp",
//       year: "2023",
//       description: "Developed expertise in building scalable backend applications using Node.js, Express, and MongoDB.",
//       link: "https://example.com/certificate/node-js" // Replace with actual link
//     },
//   ];
...
//     { id: 'projects', label: 'Projects' },
//     { id: 'skills', label: 'Skills' },
//     { id: 'certificates', label: 'Certificates' }, // Added Certificates to navigation
//     { id: 'about', label: 'About' },
//     { id: 'contact', label: 'Contact' },
//   ];
...
//           <div className="container mx-auto px-4 sm:px-6">
//             <div className="mb-12 text-center">
//               <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">My <span className="text-blue-400">Certificates</span></h2>
//               <div className="w-16 sm:w-20 h-1 bg-blue-400 mx-auto mb-6"></div>
//               <p className="text-gray-300 text-xs sm:text-sm md:text-base max-w-md mx-auto">Certifications that validate my expertise in web development and design.</p>
//             </div>
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
//               {certificates.map((cert, index) => (
//                 <div 
//                   key={index} 
//                   className="bg-gray-800 rounded-xl overflow-hidden shadow-lg transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl"
//                 >
//                   <div className="p-4 sm:p-6">
//                     <h3 className="text-lg sm:text-xl font-bold mb-2 text-white">{cert.title}</h3>
//                     <p className="text-blue-400 mb-2 text-sm sm:text-base">{cert.issuer} ({cert.year})</p>
//                     <p className="text-gray-400 mb-4 text-xs sm:text-sm">{cert.description}</p>
//                     <a 
//                       href={cert.link} 
//                       target="_blank" 
...
//             </div>
//             <div className="mt-4 md:mt-0">
//               <a href="/" className="text-blue-400 hover:text-blue-300 text-xs sm:text-sm">Back to Top</a>
//             </div>
//           </div>
//         </div>
//       </footer>
  ...
  const certificates = [
    {
      ...
      link: "https://drive.google.com/file/d/1jrpVW2XvPHSNhoEI5P5rW4OFts-fzRvT/view?usp=sharing" // Replace with actual link
    },
    {
      ...
      image: "https://github.com/NAGESHJAGTAP/full_stack_web_development_personal_Portfollio/blob/main/portfollio/src/assets/Screenshot%202025-05-16%20182947.png?raw=true", // Replace with actual image URL
      link: "https://www.hackerrank.com/certificates/iframe/457e11b81178" // Replace with actual link
    },
    {
                ...
                {[
                  ...
                  <div key={index} className="relative mb-8 sm:mb-12">
                    <div className="flex items-start">
                      ...
                      <div className="ml-6 sm:ml-8 p-4 sm:p-6 bg-gray-900 rounded-lg border-l-4 border-blue-400 shadow-lg transform transition-all duration-300 hover:scale-105 hover:bg-gray-800">
                        <span className="inline-block px-2 sm:px-3emprem py-1 bg-blue-500 bg-opacity-20 text-blue-400 rounded-full text-xs mb-3">{edu.year}</span>
                        <h3 className="text-lg sm:text-xl font-bold mb-1">{edu.degree}</h3>
                        <p className="text-blue-400 mb-2 text-sm sm:text-base">{edu.institution}</p>
                        <p className="text-gray-400 text-xs sm:text-sm">{edu.description}</p>
                      </div>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {certificates.map((cert, index) => (
                ...
                >
                  <div className="relative overflow-hidden h-48 sm:h-64">
                    <img src={cert.image} alt={cert.title} className="w-full h-full object-cover transition-transform duration-500 hover:scale-110" />
                    <div className="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent opacity-80"></div>
                    <div className="absolute bottom-0 left-0 p-4 sm:p-6">
                      <span className="px-2 sm:px-3 py-1 bg-blue-500 text-xs text-white rounded-full">{cert.issuer}</span>
                      <h3 className="text-lg sm:text-xl font-bold mt-2 text-white">{cert.title}</h3>
                    </div>
                  </div>
                  <div className="p-4 sm:p-6">
                    <p className="text-gray-400 mb-4 text-xs sm:text-sm">{cert.description}</p>
                    <div className="flex justify-between">
                      <span className="text-blue-400 text-xs sm:text-sm">{cert.year}</span>
                      <a 
                        href={cert.link} 
                        target="_blank" 
                        rel="noopener noreferrer" 
